...
public class AdmobUtils {
    ...
    public AdSize getAdSize(Activity mActivity) {
            ...
            public void onAdLoaded(@NonNull InterstitialAd interstitialAd) {
                ...
                mInterstitialAd.setFullScreenContentCallback(new FullScreenContentCallback(){
                    ...
                    public void onAdFailedToShowFullScreenContent(AdError adError) {
                        ...
                        Log.d("AdmobHelper", "The ad failed to show.");
                    }
                    ...
                    public void onAdShowedFullScreenContent() {
                        ...
                        SharePreferenceUtils.getInstance(context).saveShowFullAds(true);
                        Log.d("AdmobHelper", "The ad was shown.");
                    }
                });
            }
    ...
    public void loadNativeExitApp(Activity activity, FrameLayout frameLayout) {
        ...
        AdLoader adLoader = new AdLoader.Builder(activity, activity.getResources().getString(R.string.admob_native))
                .forNativeAd(new NativeAd.OnNativeAdLoadedListener() {
                    ...
                    public void onNativeAdLoaded(@NonNull NativeAd nativeAd) {
                        Log.d("AdmobHelper", " loadNativeDetail ----> onNativeAdLoaded");
                        if (frameLayout != null) {
                            frameLayout.setVisibility(View.VISIBLE);
                            NativeAdView adView = (NativeAdView) activity.getLayoutInflater()
                                    .inflate(R.layout.ads_native_exit_layout, null);
                            populateNativeAdExitApp(nativeAd, adView);
                ...
                .withAdListener(new AdListener() {
                    @Override
                    public void onAdFailedToLoad(@NonNull LoadAdError loadAdError) {
                        Log.d("AdmobHelper", " loadNativeDetail ----> onAdFailedToLoad");
                    }
                })
    ...
    private void populateNativeAdExitApp(NativeAd nativeAd,
                                         NativeAdView adView) {
