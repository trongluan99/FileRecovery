...
import com.jm.filerecovery.videorecovery.photorecovery.utils.DimenSizeUtils

class BaseCustomCornerView :View{
    ...
    private fun init() {
        mShadowRadius = DimenSizeUtils.density(context!!)*3
        mBgPaint.apply {
