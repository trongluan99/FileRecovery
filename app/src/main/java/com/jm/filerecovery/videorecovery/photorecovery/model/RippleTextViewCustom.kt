...
class RippleTextViewCustom : AppCompatTextView {
    ...
    private fun initAttrs(attrs:AttributeSet?) {
        ...
        val typedArray = context.obtainStyledAttributes(attrs, R.styleable.TextViewRippleStyle)
        mCornerRadius = typedArray.getDimension(R.styleable.TextViewRippleStyle_cornerRadiusTextView, 0f)
        mBgColor = typedArray.getColor(R.styleable.TextViewRippleStyle_bgColorTextView, Color.TRANSPARENT)
        typedArray.recycle()
