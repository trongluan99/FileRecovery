package com.jm.filerecovery.videorecovery.photorecovery.model.modul.recoveryaudio.task;
...
public class RecoverAudioAsyncTask extends AsyncTask<String, Integer, String> {
    ...
    public RecoverAudioAsyncTask(Context context, ArrayList<AudioEntity> mList, OnRestoreListener mOnRestoreListener) {
    ...
    protected String doInBackground(String... strAr) {
        ...
        for (int strArr = 0; strArr < this.listPhoto.size(); strArr++) {
            ...
            File fileDirectory = new File(Utils.getPathSave(mContext,mContext.getString(R.string.restore_folder_path_audio)));
            StringBuilder stringBuilder = new StringBuilder();
            stringBuilder.append(Utils.getPathSave(mContext,mContext.getString(R.string.restore_folder_path_audio)));
