package com.jm.filerecovery.videorecovery.photorecovery.model.modul.recoveryphoto.task;
...
public class RecoverPhotosAsyncTask extends AsyncTask<String, Integer, String> {
    ...
    private ArrayList<PhotoEntity> listPhoto;
    ...
    public RecoverPhotosAsyncTask(Context context, ArrayList<PhotoEntity> mList, OnRestoreListener mOnRestoreListener) {
    ...
    protected String doInBackground(String... strAr) {
        ...
        for (int strArr = 0; strArr < this.listPhoto.size(); strArr++) {
            ...
            File fileDirectory = new File(Utils.getPathSave(mContext,mContext.getString(R.string.restore_folder_path_photo)));
            StringBuilder stringBuilder = new StringBuilder();
            stringBuilder.append(Utils.getPathSave(mContext,mContext.getString(R.string.restore_folder_path_photo)));
