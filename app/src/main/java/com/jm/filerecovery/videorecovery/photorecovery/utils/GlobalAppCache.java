...
public class GlobalAppCache {
    ...
    private void addListLanguages() {
        ...
        languageModelList.add(new LanguageModel("hi", R.drawable.img_language_india, 0, "Hindi"));
        languageModelList.add(new LanguageModel("pt", R.drawable.img_language_pt, 0, "Portuguese"));
        languageModelList.add(new LanguageModel("es", R.drawable.img_language_spanish, 0, "Spanish"));
        languageModelList.add(new LanguageModel("in", R.drawable.img_language_indo, 0, "Indonesian"));
        languageModelList.add(new LanguageModel("ko", R.drawable.img_language_korean, 0, "Korean"));
